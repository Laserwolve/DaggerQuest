...
for (let i = 0; i < files.length; i++) {
    ...
    for (let texture in textures) {
        ...
        for (let sprite in sprites) {
            ...
            // else if (path.includes("absolved") && path.includes("die")) tres += `margin = Rect2( ${sprites[sprite].margin.x}, ${sprites[sprite].margin.y}, ${1024 - sprites[sprite].region.w}, ${1024 - sprites[sprite].region.h} )\n`
